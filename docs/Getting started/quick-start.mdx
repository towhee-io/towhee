...
A summary of our image embedding pipelines can be found [here](../Supported pipelines/image-embedding.md). In addition, we recommend that you browse the [hub](https://towhee.io/pipelines) to find more interesting pipelines.
