...
<KatacodaBlock>pip3 install towhee==0.6.0</KatacodaBlock>

If you want to install models in towhee, just run:
<KatacodaBlock>pip3 install towhee.models==0.6.0</KatacodaBlock>
...
<KatacodaBlock>
  output =
  embedding_pipeline('https://github.com/towhee-io/towhee/blob/main/docs/get-started/towhee.jpeg?raw=true')
</KatacodaBlock>
...
A summary of our image embedding pipelines can be found [here](../04-Supported pipelines/image-embedding.md). In addition, we recommend that you browse the [hub](https://towhee.io/pipelines) to find more interesting pipelines.
