        ...
        **kwargs,
        ...
        Arguments:
            ...
            push_to_hub (:obj:`bool`, `optional`, defaults to :obj:`False`):
                Whether or not to push your model to the hub like huggingface after saving it.
        ...
        Parameters:
            pretrained_model_name_or_path (:obj:`str` or :obj:`os.PathLike`, `optional`):
                Can be either:
                    ...
                    - A string, the `model id` of a pretrained model hosted inside a model repo like huggingface hub.
            ...
            config (:obj:`Union[PretrainedConfig, str, os.PathLike]`, `optional`):
                Can be either:
                    ...
                    - an instance of a class derived from :class:`~towhee.PretrainedConfig`,
                    - a string or path valid as input to :func:`~towhee.PretrainedConfig.from_pretrained`.
                ...
                be automatically loaded when:
                    ...
                    - The model is a model provided by the library (loaded with the `model id` string of a pretrained
                      model).
                    - The model was saved using :func:`~towhee.PreTrainedModel.save_pretrained` and is reloaded
            ...
            state_dict (:obj:`Dict[str, torch.Tensor]`, `optional`):
                ...
                :func:`~towhee.PreTrainedModel.save_pretrained` and
                :func:`~towhee.PreTrainedModel.from_pretrained` is not a simpler option.
