# coding=utf-8
# Copyright 2021 Zilliz, The Google AI Language Team and The HuggingFace Inc. team.
...
class PretrainedConfig(PushToHubMixin):
    ...
    def from_dict(cls, config_dict: Dict[str, Any], **kwargs) -> "PretrainedConfig":
        """
        Instantiates a :class:`~towhee.PretrainedConfig` from a Python dictionary of parameters.
