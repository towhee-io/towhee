...
def main():
    ...
    d_parser.add_argument('-d', '--dir', default='.', help='Directory to clone the Repo file, defaults to \'.\'.')
    ...
    subparsers.add_parser('init', parents=[ar_parser, c_parser, d_parser], add_help=False, description='Initialize the file structure for your Repo.')
