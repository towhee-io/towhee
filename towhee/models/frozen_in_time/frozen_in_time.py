...
from towhee.models.frozen_in_time.video_transformer import SpaceTimeTransformer
...
#     origial_img = Image.open('/Users/zilliz/PycharmProjects/towhee/tests/unittests/models/vit/img.jpg')
#     tfms = transforms.Compose([transforms.Resize(256),
#                                transforms.CenterCrop(224),
#                                transforms.ToTensor(),
#                                transforms.Normalize([0.5, 0.5, 0.5], [0.5, 0.5, 0.5]), ])
#     origial_img = tfms(origial_img).unsqueeze(0)
#
