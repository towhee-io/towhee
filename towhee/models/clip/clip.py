...
class ResidualAttentionBlock(nn.Module):
    ...
    def __init__(self, d_model: int, n_head: int,
                 attn_mask: Union[torch.Tensor, Callable] = None, vis=False, patch_nums=None, is_video=False):
        super().__init__()
        self.vis = vis
...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, input_resolution: int, patch_size: int, width: int, layers: int, heads: int,
        ...
        self.transformer = Transformer(width, layers, heads, vis=vis, patch_nums=self.patch_nums, is_video=True)
