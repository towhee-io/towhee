...
class Matching(nn.Module):
    ...
    def __init__(self, common_space_dim, num_text_transformer_layers, img_feat_dim, txt_feat_dim, image_disabled,
        ...
        self.url_process = TransformerPooling(input_dim=txt_feat_dim, output_dim=txt_feat_dim if not image_disabled
        else common_space_dim, num_layers=num_text_transformer_layers)
