...
def bninception(pretrained='imagenet'):
    ...
    if pretrained is not None:
        ...
        model_bn = BNInception(num_classes=num_classes)
        model_bn.load_state_dict(model_zoo.load_url(settings['url']))
        model_bn.input_space = settings['input_space']
        model_bn.input_size = settings['input_size']
        model_bn.input_range = settings['input_range']
        model_bn.mean = settings['mean']
        model_bn.std = settings['std']
    else:
