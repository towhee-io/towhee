...
class DataCollectionSchema(Iterable, DCMixins):
    """
    ...
    def __getitem__(self, index):
        ...
        return DataCollectionSchema(self._iterable[index])
    ...
    def _factory(self, iterable, parent_stream=True):
        ...
        with param_scope() as hp:
            ...
            return DataCollectionSchema(iterable)
    ...
    def range(*arg, **kws):
        ...
        [0, 1, 2, 3, 4]
        """
        return DataCollectionSchema(range(*arg, **kws))
    ...
    @register_dag
    def filter(self, unary_op: Callable, drop_empty=False) -> 'DataCollectionSchema':
        """
        ...
        if hasattr(self._iterable, 'apply') and hasattr(unary_op, '__dataframe_filter__'):
            return DataCollectionSchema(unary_op.__dataframe_apply__(self._iterable))
...
class DataFrame(DataCollectionSchema, DataFrameMixin, ColumnMixin):
    """
    ...
    def to_dc(self):
        ...
        <class 'towhee.functional.data_collection.DataCollection'>
        """
        return DataCollectionSchema(self._iterable)
