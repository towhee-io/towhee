...
class TrainerState:
    """
    A class containing the :class:`~towhee.PyTorchTrainer` inner state that will be saved along the model and optimizer
...
class TrainerControl:
    """
    A class that handles the :class:`~towhee.PyTorchTrainer` control flow. This class is used by the
