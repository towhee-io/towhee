...
class TestDataframe(unittest.TestCase):
    ...
    def test_iters(self):
        ...
        for i, row in enumerate(it):
            ...
            # print(df)
            res.append(row)
        self.assertEqual(res, [[(0, 'a')], [(1, 'b')], [(2, 'c')], [(3, 'd')], [(4, 'e')], [(5, 'a')], [(6, 'b')], [(7, 'c')], [(8, 'd')], [(9, 'e')]])       
    ...
    def test_blocking_iters(self):
        ...
        df.put((11, 'g'))
        time.sleep(.1)
        self.assertEqual(list(q.queue), [[(0, 'a')], [(1, 'b')], [(2, 'c')], [(3, 'd')], [(4, 'e')], [(5, 'a')], [(6, 'b')], [(7, 'c')], [(8, 'd')], [(9, 'e')], [(10, 'f')], [(11, 'g')]])
        self.assertEqual(list(q2.queue), [[(0, 'a'), (1, 'b'), (2, 'c'), (3, 'd')], [(4, 'e'), (5, 'a'), (6, 'b'), (7, 'c')], [(8, 'd'), (9, 'e'), (10, 'f'), (11, 'g')]])
        self.assertEqual(df.physical_size, 0)
        time.sleep(.1)
        df.put((12, 'h'))
        df.put((13, 'i'))
        time.sleep(.1)
        self.assertEqual(list(q.queue), [[(0, 'a')], [(1, 'b')], [(2, 'c')], [(3, 'd')], [(4, 'e')], [(5, 'a')], [(6, 'b')], [(7, 'c')], [(8, 'd')], [(9, 'e')], [(10, 'f')], [(11, 'g')], [(12, 'h')], [(13, 'i')]])
        self.assertEqual(list(q2.queue), [[(0, 'a'), (1, 'b'), (2, 'c'), (3, 'd')], [(4, 'e'), (5, 'a'), (6, 'b'), (7, 'c')], [(8, 'd'), (9, 'e'), (10, 'f'), (11, 'g')]])
        ...
        time.sleep(.1)
        self.assertEqual(list(q.queue), [[(0, 'a')], [(1, 'b')], [(2, 'c')], [(3, 'd')], [(4, 'e')], [(5, 'a')], [(6, 'b')], [(7, 'c')], [(8, 'd')], [(9, 'e')], [(10, 'f')], [(11, 'g')], [(12, 'h')], [(13, 'i')]])
        self.assertEqual(list(q2.queue), [[(0, 'a'), (1, 'b'), (2, 'c'), (3, 'd')], [(4, 'e'), (5, 'a'), (6, 'b'), (7, 'c')], [(8, 'd'), (9, 'e'), (10, 'f'), (11, 'g')], [(12, 'h'), (13, 'i')]])
        self.assertEqual(df.physical_size, 0)
        x.join()
        x2.join()        
