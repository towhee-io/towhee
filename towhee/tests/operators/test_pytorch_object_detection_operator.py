...
from towhee.tests.mock_operators import PYTORCH_OBJECT_DETECTION_OPERATOR_PATH, load_local_operator

cache_path = Path(__file__).parent.parent.resolve()
test_image = cache_path.joinpath('dataset/kaggle_dataset_small/train/1cef8fb87d5ca2b8a833b5f9549634aa.jpg')
