...
class Window(Node):
    ...
    def _init(self):
        self._size = self._node_repr.iter_info.param[constants.WindowConst.param.size]
        self._step = self._node_repr.iter_info.param[constants.WindowConst.param.step]
        self._cur_index = -1
